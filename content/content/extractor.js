...
const ARTICLE_TYPES = ['Article', 'NewsArticle', 'BlogPosting', 'TechArticle', 'ScholarlyArticle', 'Report'];
const PRODUCT_TYPES = ['Product', 'SoftwareApplication', 'IndividualProduct', 'ProductGroup', 'MobileApplication', 'WebApplication', 'Service'];
